...
- Uniform/Gaussian initial profile selection
...
- Rotation-dependent evaporation option: `E = E_ref sqrt(rpm/3000)`
- Gelation time estimate using a simplified solid/liquid layer model
- Dimensionless number panel for `epsilon`, `Re`, `Re*`, `Ca`, `Kn`, and `Sc`
